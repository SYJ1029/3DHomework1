...
CGameObject* CObjectsShader::PickObjectPointedByCursor(int xClient, int yClient, CCamera* pCamera)
{
	...
	for (int i = 0; i < m_nObjects; i++)
	{
		...
		if (test)
			nIntersected = m_ppObjects[i]->PickObjectByRayIntersection(xmvPickPosition, xmmtxView, &fHitDistance, m_ppObjects[0]->GetMesh()[0]);
		else
