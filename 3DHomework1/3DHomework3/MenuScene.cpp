	...
	* pd3dCommandList)
{
	...
	m_pShaders[2]->BuildObjects(pd3dDevice, pd3dCommandList, m_pTerrain);
	...
	m_pShaders[3]->BuildObjects(pd3dDevice, pd3dCommandList, m_pTerrain);
	...
	m_pShaders[4]->BuildObjects(pd3dDevice, pd3dCommandList, m_pTerrain);
